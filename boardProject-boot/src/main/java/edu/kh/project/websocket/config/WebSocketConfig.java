...
import edu.kh.project.websocket.handler.ChattingWensocketHandler;
...
public class WebSocketConfig implements WebSocketConfigurer{
	...
	private final ChattingWensocketHandler chattingWensocketHandler;
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		...
		registry
		.addHandler(chattingWensocketHandler, "/chattingSock")
		.addInterceptors(handshakeInterceptor)
		.setAllowedOriginPatterns("http://localhost/",
								"http://127.0.0.1/",
								"http://192.168.50.242/")
